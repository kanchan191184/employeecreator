...
public class DataSeeder {
        ...
        CommandLineRunner seedDatabase(
            ...
            return args -> {
                ...
                emp1.addJobRecord(createJobRecord(Employee.JobType.CONTRACT, "2023-01-15", "2024-01-01", 30));
                ...
                emp2.addJobRecord(createJobRecord(Employee.JobType.CONTRACT, "2023-01-15", "2023-08-15", 24));
                emp2.addJobRecord(createJobRecord(Employee.JobType.PERMANENT, "2024-01-01", "2025-01-01", 38));
                ...
                // emp3.addJobRecord(createJobRecord(Employee.JobType.CONTRACT, "2023-01-15", "2023-08-15", 20));
                emp3.addJobRecord(createJobRecord(Employee.JobType.PERMANENT, "2024-01-01", null, 38));
                ...
                emp4.addJobRecord(createJobRecord(Employee.JobType.CONTRACT, "2023-01-15", "2023-08-15", 15));
                emp4.addJobRecord(createJobRecord(Employee.JobType.PERMANENT, "2024-01-01", null, 38));
        ...
        private static JobRecord createJobRecord(Employee.JobType jobType, String start, String end, Integer hoursPerWeek) {
            JobRecord jr = new JobRecord();
            jr.setJobType(jobType);
            jr.setHoursPerWeek(hoursPerWeek);
